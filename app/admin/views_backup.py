...
@admin_bp.route(r'/commonapi/admin/statistics/comments/vehiclebrand', methods=['POST'])
@login_check
def vehicle_brand():
    """统计一段时间内各品牌的评价量"""
    ...
    if not params:
        return jsonify({'code': 400, 'message': '参数为空'}), 400
    city_code = params.get('citycode')
    selected_from = params.get('from')
    selected_to = params.get('to')
    ...
    for brand in vehiclebrandlist:
        ...
        for tstats in comments_brand:
            if str(tstats.get('vehicleBrand')) == brand[1]:
                statistics_list.append(tstats)
        brand_relatived_record[brand[1]] = statistics_list
...
@admin_bp.route(r'/commonapi/admin/statistics/comments/vehicletype', methods=['POST'])
@login_check
def vehicle_type():
    """统计一段时间内各车辆类型的评价量"""
...
@admin_bp.route(r'/commonapi/admin/statistics/comments/county', methods=['POST'])
@login_check
def county():
    """统计一段时间内各车辆类型的评价量"""
    ...
    res_data = {
        ...
        'trends': {
            'weekly': trend_format_trans(weekly_trends, 'countyCode', countylist),
            'monthly': trend_format_trans(monthly_trends, 'countyCode', countylist),
            'seasonly': trend_format_trans(seasonly_trends, 'countyCode', countylist),
        }
    }
    return jsonify(res_data), 200


@admin_bp.route(r'/commonapi/admin/statistics/comments/repairtype', methods=['POST'])
@login_check
def repair_type():
    """统计一段时间内各车辆类型的评价量"""
    ...
    res_data = {
        ...
        'trends': {
            'weekly': trend_format_trans(weekly_trends, 'repairType', repairtypelist),
            'monthly': trend_format_trans(monthly_trends, 'repairType', repairtypelist),
            'seasonly': trend_format_trans(seasonly_trends, 'repairType', repairtypelist),
        },
    }
    return jsonify(res_data), 200


@admin_bp.route(r'/commonapi/admin/statistics/comments/category', methods=['POST'])
@login_check
def category():
    """统计一段时间内各车辆类型的评价量"""
    ...
    res_data = {
        ...
        'trends': {
            'weekly': trend_format_trans(weekly_trends, 'category', categorylist),
            'monthly': trend_format_trans(monthly_trends, 'category', categorylist),
            'seasonly': trend_format_trans(seasonly_trends, 'category', categorylist),
        },
    }
    return jsonify(res_data), 200
